...
<head>
	...
	<title>Syracuse University Ambulance</title>
			...
			<div class="container_12">
				<div class="grid_12" id="header-container">
					...
					<div id="logo"><h1><a href="../../index.php" title="Home"><img src="../../images/logo.png" alt="SUA" /></a></h1></div>
									...
									<ul class="sf-menu">
					<li><a href="../../index.phpindex.php">Home</a></li>
     ...
     <!-- end menu -->
        ...
        <div id="main" class="clearfix">
            <div class="container_12">
                ...
                <div class="grid_12">
		<!--<div align="center"><img src="../../images/closed.png" align="center"/></div>-->
		<div align="center"><h1 class="blue">Sorry! We're no longer accepting applications.</h1></br>
			<h3 class="grey">The deadline to submit an application for Spring 2015 has passed.</h3></div>

				<div align="center"><img src="../../images/service-ambulance.jpg" align="center"/></div>

		<br />

		<div align="center"><h3>Thank you for your interest in SUA. We will be looking for new members this Fall!</h3></div>

		<div align="center"><p>Now that the online application deadline has passed, we can no longer consider new candidates for this semester. Our selection process takes a number of weeks so we are unable to accept late entries. We sincerely appreciate your interest in SUA and encourage you to apply again in the future! </p>   </div>
        	...
        	<div class="container_12">
                ...
                <div class="grid_5">
                	<div class="widget">
             		...
             		<p>After completing this application, you will receive an email confirmation. After the submission deadline on <strong>January 27th</strong>, the applications will be reviewed by our hiring committee and personnel supervisors and you will be contacted and instructed on how to continue through our interview process. </p>
             			<br/>
        ...
        <div id="footer-bottom" class="clearfix">
            <div class="container_12">
            	<div class="grid_12">
                    ...
                    <p class="right"><a href="http://su.emseschedule.com">eSchedule</a><!--<a href="#" class="scroll-top" title="Back to the Top">TOP</a>--></p>
                </div>
            </div>
        </div>
