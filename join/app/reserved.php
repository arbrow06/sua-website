        ...
        <div id="main" class="clearfix">
            <div class="container_12">
                ...
                <div class="grid_12">
                    ...
                    <p><strong>Your group reservation time has been selected.  </strong></p>
                    
                    <p>Your selection has been processed in our application reservation system and you should receive an email confirmation shortly. Please read the email as it includes some important information about the group interview process.</p>
