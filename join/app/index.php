...
<head>
	...
	<title>Syracuse University Ambulance - Join SUA!</title>
		...
		<link rel="shortcut icon" href="../../images/sua.ico">
			...
			<!--[if lt IE 7]><link type="text/css" rel="stylesheet" href="../../css/themes/ie6.css" media="screen" /><!-- color --><![endif]-->
	...
	<!--start topbar -->
		...
		<div id="outer" class="clearfix">
			<div id="topbar" class="clearfix">
				...
				<div class="grid_6" style="width:660px">
		...
		<a href="http://facebook.com/suambulance"><img src="../../images/social/facebook.png"></a>
		<a href="http://twitter.com/suambulance"><img src="../../images/social/twitter.png"></a>
		<a href="http://suambulance.tumblr.com"><img src="../../images/social/tumblr.png"></a>
		<a href="http://www.linkedin.com/groups?mostPopular=&gid=3080653"><img src="../../images/social/linkedin.png"></a>
		<a href="https://plus.google.com/112222912870823718005"><img src="../../images/social/plus.png"></a>
		<a href="http://vimeo.com/sua"><img src="../../images/social/vimeo.png"></a>
		...
		<div id="header" class="clearfix">
			<div class="container_12">
				<div class="grid_12" id="header-container">
					...
					<div id="logo"><h1><a href="../../index.php" title="Home"><img src="../../images/logo.png" alt="SUA" /></a></h1></div>
     ...
     <!-- end menu -->
        ...
        <div id="main" class="clearfix">
            <div class="container_12">
                ...
                <div class="grid_12">
                	<h2>Interested in becoming a member of SUA? We're hiring!</h2>
                    <!--<p><strong>Applications are closed, but will open again for Spring 2015 in the next few weeks. Personnel supervisors review applications twice per year, at the beginning of the Fall and Spring semesters.</strong></p>-->
            	 <h3>What To Expect...</h3>
            	 <p>If you are selected as a member of SUA, you must complete a probationary period of approximately six weeks. During this time, you will learn about the organization, your role and future training opportunities. You will be expected to:</p>
<blockquote>
<ul>
  <li>attend all mandatory training sessions</li>
  <li>work one shift per week</li>
  <li>be respectful, responsible and proactive</li>
  <li>be willing to learn and meet new people</li>
  <li>successfully complete a practical skills test and written exam</li>
</ul>
</blockquote>
	<!--<div style="text-align:center">
	<h1 style="line-height=25px;">Applications are closed for the 2014 Fall Semester,<br/> be sure to check back for applications for Spring 2015</h1>
	</div>-->

   <div align="center"><a class="large button orange" href="start.php"><span>Ready? Click Here To Get Started!</span></a></div>
                </div><!--//grid_12-->
        	...
        	<div class="container_12">
                ...
                <div class="grid_5">
                	<div class="widget">
             		...
             		<p>After completing this application, you will receive an email confirmation. After the submission deadline, the applications will be reviewed by our hiring committee and personnel supervisors and you will be contacted and instructed on how to continue through our interview process. </p>
             			<br/>
