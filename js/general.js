		...
		$("#latest-footer-tweets").tweet({
			...
			*/
			...
			$( document ).ready(function() {
				$( "#latest-footer-tweets" ).replaceWith( "<a class=\"twitter-timeline\" href=\"https://twitter.com/SUAmbulance\" data-widget-id=\"560101112523804672\">Tweets by @SUAmbulance</a><script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+\"://platform.twitter.com/widgets.js\";fjs.parentNode.insertBefore(js,fjs);}}(document,\"script\",\"twitter-wjs\");</script>" );
				$('link[src="<script type=\"text/javascript\" src=\"./js/jquery.tweet.js\"></script>"]').remove();
			});
