...
<head>
	...
	<title>Syracuse University Ambulance - Patient Care Survey</title>
	...
	<!--start topbar -->
		...
		<a href="https://plus.google.com/112222912870823718005"><img src="../images/social/google-plus.png"></a>
     ...
     <!-- end menu --> 
        ...
        <div id="main" class="clearfix">
            <div class="container_12">
                ...
                <div class="grid_12">
					<h1>Thanks!</h1>
					<p>Your results have been anonymously recorded and will be used to help us to improve our care and procedures and make sure we continue to effectively serve the Syracuse University community. While this survey is confidential and anonymous, if you would like to pass along any other suggestions or talk more specifically about an experience with us, please feel free to <a href="../contact.php">contact us</a> at any time.</p>
					
					<h3><a href="../index.php">&larr; Go back to the SUA website.</a></h3>
    ...
    <!-- start footer -->    
        ...
        <div id="footer" class="clearfix">
        	<div class="container_12">
                ...
                <div class="grid_5">
                	<div class="widget">
                    	<h3 class="widgettitle">Your Care Is Our Priority</h3>
             		<p>We are constantly working to improve our care and services and direct feedback from patients is one of the best ways to do that. Our quality assurance and quality improvement team will be collecting these results and will use this information to adapt and change our services to better fit the needs of Syracuse University.  </p>
             			<br/>
                    </div>
                </div><!--//grid_3-->
